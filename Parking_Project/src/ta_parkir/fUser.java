...
public class fUser extends javax.swing.JFrame {
    ...
    public fUser() {
        ...
        DB.config();
        con1= (Connection) DB.con1;
        stat1 = (Statement) DB.stm1;
        tampilkan_data();
...
//                "jdbc:mysql://localhost:3306/db_parkir", "root", "");
            ...
            stat1 = (Statement) con1.createStatement();
...
//Statement statement = (Statement) koneksi.createStatement();
            ...
            if (st.next()) {
                aktif(true);
                setTombol(false);
                txtnama.setText(st.getString(2));
                txtuser.setText(st.getString(3));
                txtpass.setText(st.getString(4));
    ...
    private void tampilkan_data() {
        ...
        try {
            ...
            while (st.next()) {
                ...
                o[0] = st.getString("USER_ID");
                o[1] = st.getString("NAMA");
                o[2] = st.getString("USERNAME");
                o[3] = st.getString("PASSWORD");
                tabelmapel.addRow(o);
...
//            Con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/db_parkir","root","");
