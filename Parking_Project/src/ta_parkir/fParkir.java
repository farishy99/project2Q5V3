...
//        super(parent, modal);
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        ...
        if(txtKNoPol.getText().isEmpty())
            ...
            try {
                while (st.next()){
                    size++;
                    txtKNoTiket.setText(st.getString("no_tiket").toString());
                    txtKJenis.setText(st.getString("jenis").toString());
                    txtKTglMasuk.setText(st.getString("tgl_masuk").toString());
                    txtKJamMasuk.setText(st.getString("jam_masuk").toString());
                    int hari = Integer.parseInt(st.getString("durasi_hari"));
                    int jam = Integer.parseInt(st.getString("durasi_jam"));
                    ...
                    if(hari>0){
                        ...
                        txtKDurasiJ.setText(st.getString("durasi_jam").toString()+" jam");
    ...
    public void tampil_masuk(){
        ...
        try {
            ...
            stat1=con1.createStatement();
            st=stat1.executeQuery(query);
            while (st.next()) {
                String no_tiket = st.getString("no_tiket");
                String no_pol = st.getString("no_pol");
                String jenis = st.getString("jenis");
                String tgl_masuk = st.getString("tgl_masuk");
                String jam_masuk = st.getString("jam_masuk");
    ...
    public void tampil_keluar(){
        ...
        try {
            ...
            while (st.next()) {
                ...
                String no_pol = st.getString("no_pol");
                String jenis = st.getString("jenis");
                String tgl_keluar = st.getString("tgl_keluar");
                String jam_keluar = st.getString("jam_keluar");
                String biaya = st.getString("biaya");
