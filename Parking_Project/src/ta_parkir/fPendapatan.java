...
public class fPendapatan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        mnTutup.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Out.png"))); // NOI18N
...
//            JOptionPane.showMessageDialog(this, "Gagal ambil data"+e);
        ...
        try{
            String query = "SELECT SUM(biaya) total_biaya FROM tb_parkir WHERE tgl_keluar = CURDATE() ORDER BY jam_keluar DESC";
            stat1=con1.createStatement();
            st=stat1.executeQuery(query);
            while (st.next()) {
                String biaya = st.getString("total_biaya");
                Double biaya2 = Double.parseDouble(biaya);
                String biaya_final = (rupiah.format(biaya2));
...
//            JOptionPane.showMessageDialog(this, "Gagal ambil data"+e);
        ...
        try{
            String query = "SELECT SUM(biaya) total_biaya FROM tb_parkir WHERE MONTH(tgl_keluar) = "+bulan+" AND YEAR(tgl_keluar) = "+tahun+" ORDER BY jam_keluar DESC";
            stat1=con1.createStatement();
            st=stat1.executeQuery(query);
            while (st.next()) {
                String biaya = st.getString("total_biaya");
